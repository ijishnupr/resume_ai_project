...
from auth.model import ExchangeRequest, LoginRequest, PatchUserRequest, ResetPasswordRequest
...
async def reset_password_route(request:ResetPasswordRequest, db = Depends(get_connection)):
